...
var isNullOrUndefinedOrEmpty_js = require('./isNullOrUndefinedOrEmpty.js');
...
function* getDeepObjectKeysRecursive(obj, prefix, { arrayKeysIndexStyle }) {
  ...
  if (Array.isArray(obj)) {
    ...
    if (isNullOrUndefinedOrEmpty_js.isNullOrUndefinedOrEmpty(objectEntries) && prefix) {
      yield prefix;
    } else {
...
//# sourceMappingURL=getDeepObjectKeys.js.map